...
function Tax() {
  return (
    <>
      ...
      image1= {card_image1} heading1 = "Income Tax Planning & Support" about1 = "Tax planning is the key to legally and successfully reducing tax liability. We go beyond tax compliance and proactively recommend tax saving strategies to maximize after-tax income for your business. We help prepare and timely file tax returns for your business, helping you avail all available benefits and deductions" height1= "545px"
      image2 = {card_image2} heading2 = "Presumptive Tax for Small Business" about2 = "We will help you determine how to benefit from presumptive tax scheme applicable to certain business with turnover upto Rs 2 Crore and professionals with gross revenues upto Rs 50 lakhs and avail applicable benefits where your income will be considered as 8% of turnover for ‘business’ and 50% of gross receipts for ‘professions’ respectively, making it convenient, effective & easy." height2= "545px"
      image3 = {card_image3} heading3 = "Transfer Pricing & International Tax" about3 = "With its potential to have a significant impact on the effective tax rate, businesses, especially India subsidiaries, must pay serious & close attention to their transfer pricing strategy, policies, documentation and reporting. Our services take care of transfer pricing and international tax issues for subisidaries of global entities operating in India." height3= "545px"
      image4 = {card_image4} heading4 = "GST Planning and Support" about4 = "GST is a deceptively complicated tax. The rules and regulations are complex, leading to companies either over paying or under paying what they actually owe. We review your GST profile to identify opportunities to reduce your administrative burden or potential tax savings. We also help meet your GST compliances by computing GST liability, preparing & filing applicable returns." height4= "510px"
      image5 = {card_image5} heading5 = "Audit under Income Tax & GST" about5 = "Based on Turnover or Gross receipts exceeding threshold limits prescribed by the Government, buinessess are required to get Income tax audit done. Tax audit is a review or examination of accounts of taxpayers, from an income tax viewpoint. It makes the process of income computation for filing of return of income easier." height5= "510px"
