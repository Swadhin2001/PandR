...
function Consulting() {
  return (
    <>
      ...
      image1 = {card_image1} heading1 = "Consulting for Global Entities" about1 = "Increasingly, more than ever before, global entities who want to create and operate a legal entity in India in their endeavour to do business here, need to carefully evaluate and engage firms that have expertise of guiding global companies with a proactive consulting approach, which would eliminate or mitigate all possible risks." height1= "510px"

      image2 = {card_image2} heading2 = "Consulting for Start-ups" about2 = "The key to a successful & long-lasting business is to lay the right foundation in initial stages of business formation so things don’t go wrong later. As a start-up, when you first start out, and money is tight, the do-it-yourself approach puts you in deeper mess than you can imagine. Start-up consulting can eliminate potential derailing of your business and put you on the path to success" height2= "510px"

      image3 = {card_image3} heading3 = "Consulting for Small Business" about3 = "Significant number of small businesses operate in the country in various forms. Despite being small, they are making serious contributions to the economy of the country & yet these business owners, with unlimited liabilities are the most vulnerable & need professional consulting with a partner who understands their requirements and can provide the desired levels of support" height3= "510px"

      image4 = {card_image4} heading4 = "Consulting for Top Management" about4 = "While top management of an organisation is responsible for controlling and overseeing the entire organization, designing & developing goals, strategic plans, company policies, and making decisions on the direction of the business, we guide them with all the expertise, insights and consulting they need. Our experience of working with several clients across diverse industry puts us in a postition of great strength." height4= "560px"

      image5 = {card_image5} heading5 = "Consulting for Merger & Acquisition" about5 = "Merger or an Acqusition sounds great on paper but those working behind the scenes know how complicated things can get. We work with our clients to simplify the process of M&A, providing high end consulting on pre-merger & post-merger strategies and implementation, integration, due diligence, capital strucuring and everything else that comes with and M&A process." height5= "560px"
