  ...
  return (
    <div className='container p-4'>
      <div className='row g-0'>
        <motion.div className="footer1 col-md-4 mx-5" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
        ...
        <motion.div className="footer3 col-md-2 mx-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}>
        ...
        <motion.div className="footer4 col-md-2" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}>
