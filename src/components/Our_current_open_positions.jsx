...
import image2 from '@/assets/Senior-Executive-Audit-&-Tax-3-Positions.jpeg'
                    ...
                    <div className="row my-5">
                        <div className="col-md-6">
                            <div className='d-flex border border-secondary our-curr-pos'>
                                <Image src={image1} alt="" className='our-curr-pos-img'/>
                        ...
                        <div className="col-md-6">
                            <div className='d-flex border border-secondary our-curr-pos'>
                                <Image src={image2} alt=""  className='our-curr-pos-img'/>
                                <div style={{ "padding": "15px 0px 0px 15px" }}>
